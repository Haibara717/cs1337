...
int main() {
   ...
   c3 += Complex("1.9 10.01"); //create a temporary object from a string and add it to c3
   /* Same effect as following 2 lines:
   Complex c4("1.9 10.01");
   c3 += c4;
   */
   cout << "The real and imaginary values of  c3 after new complex number is added to it: ";
   cout << c3 << endl;
   ...
   cout << "destroying dynamic variable: ";
   delete c5p;
   c5p = nullptr;
